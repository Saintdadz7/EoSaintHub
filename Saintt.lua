...
local Window = OrionLib:MakeWindow({Name = "SaintHub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "SaintHub"})

OrionLib:MakeNotification({
	Name = "SaintHub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://138409803874077",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://138409803874077",
    PremiumOnly = false
})
